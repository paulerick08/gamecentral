...
/***/ "./resources/js/jquery.time-to.js":
/*!****************************************!*\
  !*** ./resources/js/jquery.time-to.js ***!
  \****************************************/
...
(function (factory) {
  ...
  var defaults = {
    ...
    step: null,
    // callback function to exec every {stepCount} ticks
    stepCount: 1,
    // number of ticks to increment before executing stepCount
    captionSize: 0,
    ...
    fontSize: 0,
    // font-size of a digit by pixels (0 - use CSS instead)
    lang: 'en',
    // language of caption
    languages: {},
    // extra or overridden languages
    seconds: 0,
    ...
    width: 25,
    // width of a digit area
    height: 30,
    // height of a digit area
    gap: 11,
    // gap size between numbers
  ...
  var methods = {
    start: function start(sec) {
      var intervalId;

      if (sec) {
        init.call(this, sec);
        intervalId = setTimeout(tick.bind(this), 1000); // save start time
  ...
  $.fn.timeTo = function () {
    ...
    for (j = 0; j < arguments.length; j += 1) {
      ...
      if (j === 0 && typeof arg === 'string') {
        ...
        num = parseInt(arg, 10); // arg is seconds of timeout
    ...
    if (options.timeTo) {
      ...
      if (_typeof(time) === 'object' && time.getTime) {
  ...
  function tick(digit) {
    ...
    if (n < 0 || n > data.limits[digit]) {
      if (n < 0) {
        n = data.limits[digit]; // fix for hours when day changing
    ...
    && digit === data.iHour && data.displayDays > 0 && data.vals[digit - 1] === 2 && data.vals[digit] === 3) {
      n = 0;
      tick.call(this, digit - 1);
    }
...
/***/ 1:
/*!**********************************************!*\
  !*** multi ./resources/js/jquery.time-to.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/dev/Documents/gamecentral-v2/resources/js/jquery.time-to.js */"./resources/js/jquery.time-to.js");
